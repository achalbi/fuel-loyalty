...
- [ ] `notification_schedules` supports channel + target + `campaign_id`; the runner sends targeted, multi-channel messages, still lease-guarded and idempotent.
